    ...
    <div className="min-h-screen page-gradient">
      ...
      <header className="text-center relative z-10 py-16">
        <div className="container mx-auto px-6">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed font-mono text-lg">
            How The Overmind Gallery collects, uses, and protects information in a decentralized environment.
          </p>
        </div>
      </header>
      ...
      <section className="container mx-auto px-6 py-16 relative z-10 max-w-4xl">
        <div className="space-y-12">
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-secondary/10 border border-primary/30 p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-primary mb-2 text-lg">Blockchain Transparency</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              <p>
                The Overmind Gallery ("the platform," "we," "us," or "our") operates a blockchain-based NFT marketplace built on the Intuition Network (the "Platform"). The Overmind Gallery enables users to auction NFTs, place bids, and participate in a reward mechanism where outbid participants may earn up to 10% of their bid amount, subject to smart contract rules.
              </p>
              <p>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              ...
              <p>
                This policy does <span className="text-secondary font-semibold">not</span> apply to third-party services, wallets, or blockchain explorers that you may use in connection with The Overmind Gallery.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-6">
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-primary">3.1 Information You Provide Directly</h3>
                <div className="text-muted-foreground leading-relaxed space-y-2">
                  <p>
                    We do <span className="text-secondary font-semibold">not</span> require users to create traditional accounts. However, you may voluntarily provide:
                  </p>
                  <ul className="space-y-2 list-disc list-inside ml-4">
                    <li>Communications sent to us (support requests, feedback, inquiries)</li>
                    <li>Profile or display information</li>
                  </ul>
                </div>
              </div>

              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-primary">3.2 Blockchain Information (Public by Nature)</h3>
                <div className="text-muted-foreground leading-relaxed space-y-2">
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-primary">3.3 Automatically Collected Information</h3>
                <div className="text-muted-foreground leading-relaxed space-y-2">
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              ...
              <ul className="space-y-2 list-disc list-inside ml-4">
                ...
                <li>The Overmind Gallery does not manually control payouts</li>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              <p>The Overmind Gallery may use minimal cookies or similar technologies for:</p>
              <ul className="space-y-2 list-disc list-inside ml-4">
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              ...
              <ul className="space-y-2 list-disc list-inside ml-4">
                ...
                <li>To protect the rights, safety, and integrity of The Overmind Gallery or users</li>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              <p>
                The Overmind Gallery is accessible globally. By using the Platform, you understand that data may be processed in jurisdictions with different data protection standards.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pl-8 space-y-3 text-muted-foreground leading-relaxed">
              <p>
                The Overmind Gallery is not intended for individuals under the age of 18 or under the age of adulthood in your jurisdiction. We do not knowingly collect personal data from minors.
              </p>
            </div>
          </div>
          ...
          {/* Disclaimer */}
          <Card className="bg-card/30 backdrop-blur-md border-border/30 p-6 mt-12">
