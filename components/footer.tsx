...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border/20 bg-background/95 backdrop-blur-sm mt-auto">
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-tight max-w-sm">
              An auction-based decentralized NFT gallery where you bid to own NFTs and earn rewards if outbid.
            </p>
          </div>

          {/* Product Links */}
          <div>
            <h3 className="text-sm font-semibold mb-3 bg-gradient-to-r from-cyan-400 to-violet-400 bg-clip-text text-transparent">Product</h3>
          ...
          {/* Community / Social */}
          <div>
            <h3 className="text-sm font-semibold mb-3 bg-gradient-to-r from-cyan-400 to-violet-400 bg-clip-text text-transparent">Community</h3>
            <ul className="space-y-1.5">
              <li>
                <a 
        ...
        {/* Footer Bottom */}
        <div className="mt-6 pt-3 border-t border-border/15">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            <p className="text-sm text-muted-foreground">
              © {currentYear} The Overmind Gallery. All rights reserved.
            </p>
            <p className="text-xs text-muted-foreground/70">
              You are blessed sweet baby child of the overmind.
            </p>
          </div>
        </div>
      </div>
